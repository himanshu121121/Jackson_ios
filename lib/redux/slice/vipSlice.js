...
export const confirmApplePayment = createAsyncThunk(
  ...
  async (
    ...
    try {
      console.log('📦 [confirmApplePayment] Sending request:', {
        subscriptionId,
      ...
      console.error('❌ [confirmApplePayment] Error:', error)
...
const initialState = {
  ...
  appleProductId: null, // Apple IAP product ID
  modalLocked: false,
}
